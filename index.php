	...
	<div class="row">
		<div class="col-sm-12">
			<div class="row">
				...
				<div class="col-sm-7">
					<div class="row">
						<div class="col-sm-12 h1 text-center text-success"><big><b><i>SADIKA MODERN LIBRARY</i></b></big></div>
						<div class="col-sm-12 h2 text-center text-success"><big><b><i>सादिका आधुनिक पुस्तकालय</i></b></big></div>
					</div>
				</div>
			</div>
        </div>					
 ...
 <div class="container-fluid"style="background:#dab5a2">
  <div class="row">
    <div class="col-sm-12 bg-success mt-3">
           <p class="h5 text-white mt-2"><marquee behavior=alternate> @ COPYRIGHT 2022 ON 03/03/2022 DEVLOPED BY:SADIKA</marquee></p>
    </div>
  </div>
 </div>     
    ...
    <div class="modal-dialog">
        <div class="modal-content hh">
            ...
            <div class="modal-body"><BR>
				<h2 class="text-white text-center"><i>WELCOME TO<BR>SADIKA MODERN LIBRARY</i></h2>
         <h4 class="text-white text-center mt-3">MANAGER:- ER. SADIKA </h4>
